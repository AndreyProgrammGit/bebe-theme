...
Redux::set_section(
	$opt_name,
	array(
		'title'            => esc_html__( 'Header options', 'bebe' ),
		'id'               => 'header',
		'desc'             => esc_html__( 'Data to be displayed in Header', 'bebe' ),
	...
	Redux::set_section(
		...
		array(
			...
			'desc'             => esc_html__( 'Upload the logo and specify the slogan', 'bebe' ),
			'id'               => 'site_logos',
			'subsection'       => true,
			...
			'fields'           => array(
				array(
					...
					'type'     => 'media',
					'url'	   => true,
					'title'    => esc_html__( 'Logo', 'bebe' ),
					'subtitle' => esc_html__( 'Upload here your logo', 'bebe' ),
					'desc'     => esc_html__( 'Recommended size: 320px-120px', 'bebe' ),
					'default'  => '',
				),
				array(
					'id'       => 'bebelogosmall',
					'type'     => 'media',
					'title'    => esc_html__( 'Logo Small', 'bebe' ),
					'subtitle' => esc_html__( 'Upload here your logo', 'bebe' ),
					'desc'     => esc_html__( 'Recommended size: 200px-70px', 'bebe' ),
					'default'  => '',
				),
				array(
				...
				array(
					...
					'subtitle' => esc_html__( 'Type here your slogan', 'bebe' ),
					'desc'     => esc_html__( 'Your Slogan', 'bebe' ),
	...
	Redux::set_section(
		...
		array(
			...
			'desc'             => esc_html__( 'Upload data for you slider', 'bebe' ),
			'id'               => 'home_slider',
			'subsection'       => true,
			'customizer_width' => '700px',
			'fields'           => array(
				array(
					...
					'desc'        => esc_html__( 'This field will store all slides values into a multidimensional array to use into a foreach loop.', 'bebe' ),
					'placeholder' => array(
						'title'       => esc_html__( 'This is a title', 'bebe' ),
						'description' => esc_html__( 'Description Here', 'bebe' ),
						'url'         => esc_html__( 'Give us a link!', 'bebe' ),
					),
				),
			),
		)
...
Redux::set_section(
	...
	Redux::set_section(
		...
		array(
			'title'            => esc_html__( 'Social Links', 'bebe' ),
			'desc'             => esc_html__( 'Type here social lings', 'bebe' ),
			'id'               => 'social_links',
			'subsection'       => true,
			'customizer_width' => '700px',
			'fields'           => array(
				array(
					'id'       => 'fb',
					'type'     => 'text',
					'title'    => esc_html__( 'Faceboock Link', 'bebe' ),
					'subtitle' => esc_html__( 'Type here your fb', 'bebe' ),
					'desc'     => esc_html__( 'Your fb', 'bebe' ),
					'default'  => '',
				),
				array(
					'id'       => 'insta',
					'type'     => 'text',
					'title'    => esc_html__( 'Instargam', 'bebe' ),
					'subtitle' => esc_html__( 'Type here your inst', 'bebe' ),
					'desc'     => esc_html__( 'Your Inst', 'bebe' ),
					'default'  => '',
				),
				array(
					'id'       => 'pin',
					...
					'subtitle' => esc_html__( 'Type here your Pinterest', 'bebe' ),
					'desc'     => esc_html__( 'Your Pinterest', 'bebe' ),
					'default'  => '',
				),
				array(
					'id'       => 'twi',
					...
					'subtitle' => esc_html__( 'Type here your Twitter', 'bebe' ),
					'desc'     => esc_html__( 'Your Twitter', 'bebe' ),
					'default'  => '',
				),
				array(
					'id'       => 'yt',
					...
					'subtitle' => esc_html__( 'Type here your YouTube', 'bebe' ),
					'desc'     => esc_html__( 'Your Yuotube', 'bebe' ),
					'default'  => '',
				),
			),
		)
...
Redux::set_section(
	$opt_name,
	array(
		'title'            => esc_html__( 'Footer options', 'bebe' ),
		'id'               => 'footer',
		'desc'             => esc_html__( 'Data to be displayed in Header', 'bebe' ),
		'customizer_width' => '400px',
		'icon'             => 'el el-home',
		...
		array(
			...
			'fields'           => array(
				array(
					'id'       => 'footerlogo',
					'type'     => 'media',
					'title'    => esc_html__( 'Logo in Footer', 'bebe' ),
					'subtitle' => esc_html__( 'Upload here your logo', 'bebe' ),
					'desc'     => esc_html__( 'Recommended size: 80px-40px', 'bebe' ),
					'default'  => '',
				),
			),
		)
	...
	Redux::set_section(
		...
		array(
			...
			'desc'             => esc_html__( 'Type here info for footer', 'bebe' ),
			'id'               => 'footer_data',
			'subsection'       => true,
			'customizer_width' => '700px',
			'fields'           => array(
				array(
					...
					'subtitle' => esc_html__( 'Use any of the features of WordPress editor inside your panel!', 'bebe' ),
	...
	Redux::set_section(
		$opt_name,
		array(
			'title'            => esc_html__( 'Contacts', 'bebe' ),
			'desc'             => esc_html__( 'Type here info for contacts', 'bebe' ),
			'id'               => 'footer_contact',
			'subsection'       => true,
			'customizer_width' => '700px',
			'fields'           => array(
				array(
					...
					'subtitle' => esc_html__( 'Type here your phone', 'bebe' ),
					'desc'     => esc_html__( 'Your phone', 'bebe' ),
					'default'  => '8 800 435-17-20',
				),
				array(
					'id'       => 'email',
					'type'     => 'text',
					'title'    => esc_html__( 'Email', 'bebe' ),
					'subtitle' => esc_html__( 'Type here your email', 'bebe' ),
					'desc'     => esc_html__( 'Your email', 'bebe' ),
					'validate' => 'email',
					'msg'	   => esc_html__('Wrong email', 'bebe'),
					'default'  => 'nfo@bebe.co.uk',
				),
				array(
					'id'       => 'location',
					'type'     => 'text',
					'title'    => esc_html__( 'Location', 'bebe' ),
					'subtitle' => esc_html__( 'Type here your location', 'bebe' ),
					'desc'     => esc_html__( 'Your location', 'bebe' ),
					'default'  => 'Germany Berlin, Main street 43',
				),
			),
		)
	);
Redux::set_section(
	$opt_name,
	array(
		'title'            => esc_html__( 'About page', 'bebe' ),
		'id'               => 'about_page',
		'desc'             => esc_html__( 'Data to be displayed in Header', 'bebe' ),
		'customizer_width' => '400px',
		'icon'             => 'el el-home',
	...
	Redux::set_section(
		$opt_name,
		array(
			'title'            => esc_html__( 'Slider_about', 'bebe' ),
			'desc'             => esc_html__( 'Slider for about page', 'bebe' ),
			'id'               => 'slider_abot',
			'subsection'       => true,
			'customizer_width' => '700px',
			'fields'           => array(
...
Redux::set_section(
	$opt_name,
	array(
		'title'            => esc_html__( 'Post type settings', 'bebe' ),
		...
		'fields'		   => [
			[
				...
				'type'        => 'text',
				'validate'    => 'numeric',
				'title'       => esc_html__( 'Post per Page', 'bebe' ),
				'subtitle'    => esc_html__( 'On rooms post type', 'bebe' ),
				'desc'        => esc_html__( 'How many posts you want to show on the Rooms Archive Page.', 'bebe' ),
				'default'	  => '6'
			],
		],
	)
